...
export default function ProfilePage() {
  ...
  return (
    <div
      className={`container mx-auto grid gap-6 px-4 py-8 ${
        isEditing ? "max-w-6xl lg:grid-cols-12" : "max-w-5xl"
      }`}
    >
      <div className={isEditing ? "lg:col-span-4" : "mx-auto w-full max-w-xl"}>
