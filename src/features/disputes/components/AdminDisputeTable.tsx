      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="w-[200px] font-black uppercase tracking-wider text-[11px]">Lý do khiếu nại</TableHead>
            ...
            <TableHead className="w-[100px] text-right font-black uppercase tracking-wider text-[11px]">Thao tác</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
...
function AdminDisputeRow({
  ...
  // Call `/api/orders/{orderId}/products/{productId}` directly as admin disputes list provides productId
  ...
  return (
    <TableRow className="hover:bg-muted/10">
      ...
      <TableCell className="max-w-[200px] truncate text-sm font-medium" title={dispute.reason}>
        {dispute.reason}
      </TableCell>
      ...
      <TableCell className="text-right">
        {dispute.status === 0 ? (
          <Button
            ...
            onClick={() => onAssign?.(dispute.disputeId)}
          ...
          <span className="text-xs text-muted-foreground font-semibold">Đã xong</span>
        )}
      </TableCell>
    </TableRow>
  );
